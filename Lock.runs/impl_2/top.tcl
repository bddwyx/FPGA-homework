...
set rc [catch {
  ...
  add_files -quiet E:/FPGA-homework/Lock.runs/synth_2/top.dcp
...
set rc [catch {
  ...
  create_report "impl_2_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file top_timing_summary_routed.rpt -warn_on_violation  -rpx top_timing_summary_routed.rpx"
